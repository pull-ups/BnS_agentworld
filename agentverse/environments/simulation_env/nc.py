...
from agentverse.agents.simulation_agent.nc import NcAgent
...
@EnvironmentRegistry.register("nc")
class ncEnvironment(BaseEnvironment):
    """
    ...
    async def step(self) -> List[Message]:
        ...
        messages = await asyncio.gather(
            *[self.agents[i].astep(prompt="Hi, What's your name?") for i in agent_ids]
        )
